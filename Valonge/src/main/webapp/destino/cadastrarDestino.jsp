...
<link
	...
	rel="stylesheet">
<title>Vá longe - Cadastrar destinos</title>
<style>
#inputDetalhes {
	resize: none;
	height: 120px;
...
<body>
	...
	<div class="container my-5 py-5 border border-primary-subtle rounded">
      ...
      <img width="200px" id="img"/>
		 ...
		 <div>
  	<div class="alert alert-primary my-2"><a class="text-decoration-none" href="../destino">Mostrar Destinos cadastrados</a></div>
  </div>
	</div>
